...
/// @date    Mon, 9 Jul 2001
/// @version $Id: MSPersonControl.cpp 15692 2014-02-22 09:17:02Z behrisch $
///
...
MSPerson*
MSPersonControl::getPerson(const std::string& id) {
	const std::map<std::string, MSPerson*>::iterator i = myPersons.find(id);
	if (i == myPersons.end()) {
		return 0;
    }
...
MSPersonControl::constPersIt
MSPersonControl::persBegin() const {
    return myPersons.begin();
}

MSPersonControl::constPersIt
MSPersonControl::persEnd() const {
