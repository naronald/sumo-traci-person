...
/// @date    Mon, 9 Jul 2001
/// @version $Id: MSPersonControl.h 15692 2014-02-22 09:17:02Z behrisch $
///
...
public:
    ...
    /** @brief Returns the person with the given id
     *
     * If no person with the given id is stored in "myPersonDict", 0
     *  is returned.
     *
     * @param[in] id The id of the person to retrieve
     * @return The person with the given id, 0 if no such person exists
     */
    MSPerson* getPerson(const std::string& id);

	typedef std::map<std::string, MSPerson*>::const_iterator constPersIt;

    /** @brief Returns the begin of the internal person map
     *
     * @return The begin of the internal person map
     */
	constPersIt persBegin() const;

    /** @brief Returns the end of the internal person map
     *
     * @return The end of the internal person map
     */
	constPersIt persEnd() const;
